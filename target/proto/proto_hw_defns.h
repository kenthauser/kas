#ifndef KAS_PROTO_UC_PROTO_UC_HW_DEFNS_H
#define KAS_PROTO_UC_PROTO_UC_HW_DEFNS_H
...
//////////////////////////////////////////////////////////////////////////////
//
// Declare hierarchy of instruction sets. `PROTO_LCcf` is base type, supported
// by all processors. From this derive `PROTO_LC` tree & the `coldfire` tree.
...
using PROTO_LC = cpu_defn<STR("base"), list<>>;
...
using cpu_is_list = list<
              PROTO_LC          // default
            , PROTO_LC          // list of valid types (must include `default`)
            >;
...
using PROTO_LC_hw_defs = hw_defs<cpu_is_list, fpu_cp_defn, mmu_cp_defn>;
using cpu_defs_t  = PROTO_LC_hw_defs;
