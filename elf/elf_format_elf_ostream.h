#ifndef KAS_ELF_ELF_FORMAT_ELF_OSTREAM_H
#define KAS_ELF_ELF_FORMAT_ELF_OSTREAM_H

namespace kas::elf
{

template <typename OSTREAM>
OSTREAM& operator<< (OSTREAM& os, std::pair<elf_object const&, Elf64_Sym const&> s) 
{
...
template <typename OSTREAM>
OSTREAM& operator<< (OSTREAM& os, std::pair<elf_object const&, Elf64_Rel const&> s)
{
    using decode = std::pair<unsigned, const char *>;
    ...
    print(obj.relocs.get_info(r_type),  0);
...
template <typename OSTREAM>
OSTREAM& operator<< (OSTREAM& os, std::pair<elf_object const&, Elf64_Rela const&> s)
{
    using decode = std::pair<unsigned, const char *>;
