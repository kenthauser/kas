#ifndef KAS_ELF_ELF_FORMAT_AOUT_OSTREAM_H
#define KAS_ELF_ELF_FORMAT_AOUT_OSTREAM_H
...
OSTREAM& operator<< (OSTREAM& os, std::pair<elf_object const&, nlist const&> s) 
{
...
OS& operator<< (OS& os, std::pair<elf_object const&, relocation_info const&> s) 
{
    using decode = std::pair<unsigned, const char *>;
