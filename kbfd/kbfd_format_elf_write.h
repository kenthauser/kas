#ifndef KBFD_KBFD_FORMAT_ELF_WRITE_H
#define KBFD_KBFD_FORMAT_ELF_WRITE_H

#include "kbfd_format_elf.h"
#include "kbfd_section_data.h"
...
void kbfd_format_elf<ENDIAN, HEADERS, Ts...>::
    write(kbfd_object& obj, std::ostream& os) const
{
    ...
    if (!sh_string_p)
        sh_string_p = new ks_string(obj, ".shstrtab");
