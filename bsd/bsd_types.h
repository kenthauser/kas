#ifndef KAS_BSD_BSD_TYPES_H
#define KAS_BSD_BSD_TYPES_H
...
namespace kas::bsd
{
    ...
    namespace parser
    {
        using dot_parser_x3 = x3::rule<struct _dot, core::addr_ref>;
        BOOST_SPIRIT_DECLARE(dot_parser_x3)
        
        using sym_parser_x3 = x3::rule<struct _sym, core::symbol_ref>;
        BOOST_SPIRIT_DECLARE(sym_parser_x3)
    }
}


// no types to add, just parsers
