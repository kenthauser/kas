#ifndef KAS_Z80_OPC_BRANCH_H
#define KAS_Z80_OPC_BRANCH_H
...
struct z80_opc_branch : z80_stmt_opcode
{
    using base_t::base_t;


    OPC_INDEX();
    const char *name() const override { return "Z80_BRANCH"; }
                 ...
                 ) override
    {
        ...
        inserter(std::move(args.front().expr), M_SIZE_AUTO);
        return *this;
    }
