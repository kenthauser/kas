#ifndef KAS_ARM_ARM_FORMAT_FLOAT_H
#define KAS_ARM_ARM_FORMAT_FLOAT_H

//
// The ARM architecture supports IEEE floating point formats
//
...
//
// EXAMPLE: Add support for the ARM specific types (extended, packed)
//
...
struct arm_format_float : expression::detail::ieee754_base<arm_format_float, e_float_t>
{
    using base_t = ieee754_base<arm_format_float, e_float_t>;
...
private:
    ...
    // ARM "packed" output format (80-bits)
    // NB: [emits as 3, 32-bit words = 96-bits]
    result_type arm_packed(flt_t const& flt) const
    {
