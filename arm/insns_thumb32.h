...
, defn<t32_cS, STR("tst"), OP<0xf010'0f00>, FMT_     , REG, THB_U12>
, defn<t32_cS, STR("and"), OP<0xf010'0000>, FMT_, REG, NPC, THB_U12>
, defn<t32_c , STR("and"), OP<0xf000'0000>, FMT_, REG, REG, THB_U12>
, defn<t32_cs, STR("bic"), OP<0xf020'0000>, FMT_, REG, REG, THB_U12>
, defn<t32_cs, STR("mov"), OP<0xf04f'0000>, FMT_, REG     , THB_U12> 
, defn<t32_cs, STR("orr"), OP<0xf04f'0000>, FMT_, NPC, REG, THB_U12> 
, defn<t32_cs, STR("mvn"), OP<0xf06f'0000>, FMT_, REG     , THB_U12> 
, defn<t32_cs, STR("orn"), OP<0xf06f'0000>, FMT_, NPC, REG, THB_U12> 
, defn<t32_cS, STR("teq"), OP<0xf090'0f00>, FMT_     , REG, THB_U12>
, defn<t32_cS, STR("eor"), OP<0xf090'0000>, FMT_, REG, NPC, THB_U12>
, defn<t32_c , STR("eor"), OP<0xf080'0000>, FMT_, REG, REG, THB_U12>
, defn<t32_cS, STR("cmn"), OP<0xf110'0f00>, FMT_     , REG, THB_U12>
, defn<t32_cS, STR("add"), OP<0xf110'0000>, FMT_, REG, NPC, THB_U12>
, defn<t32_c , STR("add"), OP<0xf100'0000>, FMT_, REG, REG, THB_U12>
, defn<t32_cs, STR("adc"), OP<0xf040'0000>, FMT_, REG, REG, THB_U12>
, defn<t32_cs, STR("sbc"), OP<0xf040'0000>, FMT_, REG, REG, THB_U12>
, defn<t32_cS, STR("cmp"), OP<0xf1b0'0f00>, FMT_, REG     , THB_U12>
, defn<t32_cS, STR("sub"), OP<0xf1b0'0000>, FMT_, REG, NPC, THB_U12>
, defn<t32_c , STR("sub"), OP<0xf1a0'0000>, FMT_, REG, REG, THB_U12>
, defn<t32_cs, STR("rsb"), OP<0xf1c0'0000>, FMT_, REG, REG, THB_U12>
>;
...
, defn<t32_c, STR("addw"), OP<0xf200'0000>, FMT_, REG, U12>
, defn<t32_c, STR("add") , OP<0xf200'0000>, FMT_, REG, U12>
, defn<t32_c, STR("movw"), OP<0xf240'0000>, FMT_, REG, U16>
, defn<t32_c, STR("mov") , OP<0xf240'0000>, FMT_, REG, U16>
, defn<t32_c, STR("adr") , OP<0xf2af'0000>, FMT_, REG, DIRECT>   // direct before
, defn<t32_c, STR("subw"), OP<0xf2a0'0000>, FMT_, REG, U12>
, defn<t32_c, STR("sub") , OP<0xf2a0'0000>, FMT_, REG, U12>
, defn<t32_c, STR("movt"), OP<0xf2c0'0000>, FMT_, REG, U16>
, defn<t32_c, STR("ssat"), OP<0xf300'0000>, FMT_, REG, U5, REG, SHIFT>    // XXX
, defn<t32_c, STR("ssat"), OP<0xf300'0000>, FMT_, REG, U5, REG>    // XXX
, defn<t32_c, STR("ssat16"), OP<0xf320'0000>, FMT_, REG, SAT1_16, REG>
, defn<t32_c, STR("sbfx"), OP<0xf640'0000>, FMT_, REG, REG, U5, SAT1_32>
, defn<t32_c, STR("bfc") , OP<0xf36f'0000>, FMT_, REG     , U5, SAT1_32>
, defn<t32_c, STR("bfi") , OP<0xf360'0000>, FMT_, REG, NPC, U5, SAT1_32>
, defn<t32_c, STR("usat"), OP<0xf380'0000>, FMT_, REG, U5, REG, SHIFT>    // XXX
, defn<t32_c, STR("usat"), OP<0xf380'0000>, FMT_, REG, U5, REG>    // XXX
, defn<t32_c, STR("usat16"), OP<0xfb20'0000>, FMT_, REG, SAT1_16, REG>
, defn<t32_c, STR("ubfx"), OP<0xfe40'0000>, FMT_, REG, REG, U5, SAT1_32>
>;
...
, defn<t32_u, STR("cps"), OP<0xf3af'8000>, FMT_, IFLAGS, U5>  // IMM5 = mode
, defn<t32_u, STR("cps"), OP<0xf3af'8000>, FMT_, U5>          // IMM5 = mode
...
, defn<t32_c, STR("dbg"), OP<0xf3af'80f0>, FMT_, U4>
...
, defn<t32_cS, STR("sub"), OP<0xf3de'8f00>, FMT_, PC, LR, U8>     // aka ERET
...
, defn<t32_u, STR("hvc"), OP<0xf7e0'8000>, FMT_, U16>
, defn<t32_c, STR("smc"), OP<0xf7f0'8000>, FMT_, U4>
, defn<t32_c, STR("b"), OP<0xf000'8000>, FMT_ , OFFSET_25>
, defn<t32_c, STR("udf"), OP<0xf7f0'a000>, FMT_ , U16>
...
, defn<t32_c , STR("srsdb"), OP<0xe80b'c000>, FMT_, SP   , U5>
, defn<t32_c , STR("srsdb"), OP<0xe82b'c000>, FMT_, SP_WB, U5>
...
, defn<t32_c , STR("srs")  , OP<0xe98b'c000>, FMT_, SP   , U5>
, defn<t32_c , STR("srsia"), OP<0xe98b'c000>, FMT_, SP   , U5>
, defn<t32_c , STR("srs")  , OP<0xe9ab'c000>, FMT_, SP_WB, U5>
, defn<t32_c , STR("srsia"), OP<0xe9ab'c000>, FMT_, SP_WB, U5>
...
// XXX Rd is optional. create TMP macro after fleshed out
, defn<t32_cs, STR("lsl")  , OP<0xea4f'0000>, FMT_, REG, REG, U5_NZ>
, defn<t32_cs, STR("mov")  , OP<0xea4f'0000>, FMT_, REG, REG>
, defn<t32_cs, STR("lsr")  , OP<0xea4f'0010>, FMT_, REG, REG, U5>
, defn<t32_cs, STR("asr")  , OP<0xea4f'0020>, FMT_, REG, REG, U5>
, defn<t32_cs, STR("ror")  , OP<0xea4f'0030>, FMT_, REG, REG, U5_NZ>
, defn<t32_cs, STR("rrx")  , OP<0xea4f'0030>, FMT_, REG, REG>

// XXX Rd and SHIFT optional for all...
// XXX create TMP macros after fleshed out
