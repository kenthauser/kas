...
, insn<sz_lwb, STR("cmp2"), OP<0x00c0'0000, cpu32>, FMT_0RM_28RM, CONTROL, GEN_REG>
, insn<sz_lwb, STR("chk2"), OP<0x00c0'0800, cpu32>, FMT_0RM_28RM, ALTERABLE, GEN_REG>
, insn<sz_vl , STR("extb"), OP<0x49c0, cpu32>, FMT_0, DATA_REG>
, insn<sz_l  , STR("link"), OP<0x4808, cpu32>, FMT_0, ADDR_REG, IMMED>
