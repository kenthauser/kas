...
struct add_m68k_options
{
    void operator()(options::po_defns& defns) const
    {
        ...
        defns.add("M68K/Coldfire options")
            ("#-m,-march,:<arch>,m68020", "set architecture"
               , hw::cpu_defs, core::hardware::cb_hw_isa(hw::cpu_defs))
            ("#-m,-mcpu,:<cpu>"       , "set cpu"
               , hw::cpu_defs, core::hardware::cb_hw_isa(hw::cpu_defs))
            ("-m,!68851"              , "enable/disable  m68k architecture extension"
               , hw::cpu_defs, core::hardware::cb_hw_has(hw::cpu_defs, hw::mmu{}))
            ("-m,!68881"              , "enable/disable  m68k architecture extension"
               , hw::cpu_defs, core::hardware::cb_hw_has(hw::cpu_defs, hw::fpu{}))
            ...
            ("-m,!div"                , "enable/disable  ColdFire architecture extension"
               , hw::cpu_defs, core::hardware::cb_hw_has(hw::cpu_defs, hw::div{}))
            ("-m,!usp"                , "enable/disable  ColdFire architecture extension"
               , hw::cpu_defs, core::hardware::cb_hw_has(hw::cpu_defs, hw::usp{}))
            ("-m,!mac"                , "enable/disable  ColdFire architecture extension"
               , hw::cpu_defs, core::hardware::cb_hw_has(hw::cpu_defs, hw::mac{}))
            ("-m,!emac"               , "enable/disable  ColdFire architecture extension"
               , hw::cpu_defs, core::hardware::cb_hw_has(hw::cpu_defs, hw::emac{}))
            ("-l,:,2"			      , "use 1 word for refs to undefined symbols"
                                                                , o.undef_words)
            ("-pic, -k"		          , "generate position independent code"
                                                                , o.do_pic)
            ("-S"			          , "turn jbsr into jsr"    , o.use_jsr)
            ("--pcrel"                , "never turn PC-relative branches into absolute jumps"
                                                                , o.do_pcrel)
            ("--reg-prefix,=allow,none,allow,require", "require register prefix"
                                                                , o.reg_prefix)
            ("--register-prefix-optional,=1"
