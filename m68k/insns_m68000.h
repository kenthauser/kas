...
, insn<sz_lwb, STR("move"),  OP<0x0000, void, INFO_SIZE_MOVE>, FMT_0RM_6RM, GEN, ALTERABLE>
, insn<sz_lw , STR("movea"), OP<0x0000, void, INFO_SIZE_MOVE>, FMT_0RM_6RM, GEN, ADDR_REG>

// move quick (three ways to spell it)
, insn<sz_vl, STR("moveq"), OP<0x7000>, FMT_8I_9, Q_IMMED, DATA_REG>
, insn<sz_l , STR("move"),  OP<0x7000>, FMT_8I_9, Q_IMMED, DATA_REG>

// move immediate zero: map to clear
, insn<sz_lwb, STR("move"), OP<0x4200>, FMT_X_0RM, Z_IMMED, DATA_ALTER>

// CCR, SR moves
, insn<sz_vw, STR("move"), OP<0x46c0>,           FMT_0RM,   DATA, SR>
, insn<sz_vw, STR("move"), OP<0x40c0>,           FMT_X_0RM, SR,   DATA_ALTER>
, insn<sz_vw, STR("move"), OP<0x44c0>,           FMT_0RM,   DATA, CCR>
, insn<sz_vw, STR("move"), OP<0x42c0, read_ccr>, FMT_X_0RM, CCR,  DATA_ALTER>

// move USP
, insn<sz_l, STR("move"), OP<0x4e60>, FMT_0  , ADDR_REG, USP>
, insn<sz_l, STR("move"), OP<0x4e68>, FMT_X_0, USP, ADDR_REG>
...
// movep
, insn<sz_lw, STR("movep"), OP<0x0188, movep, INFO_SIZE_WL>, FMT_9_0, DATA_REG, MOVEP>
...
, insn<sz_v  , STR("exg"),  OP<0xc148, m68k>, FMT_9_0, ADDR_REG, ADDR_REG>
, insn<sz_v  , STR("exg"),  OP<0xc188, m68k>, FMT_9_0, ADDR_REG, DATA_REG>
, insn<sz_v  , STR("exg"),  OP<0xc188, m68k>, FMT_0_9, DATA_REG, ADDR_REG>
>;
...
, insn<sz_l  , NAME, OP<OPC + 0x080>,    FMT_0RM_9, GEN, DATA_REG>
, insn<sz_l  , NAME, OP<OPC + 0x180>,    FMT_9_0RM, DATA_REG, MEM_ALTER>
, insn<sz_wb , NAME, OP<OPC_IMMED,   m68k>, FMT_X_0RM, IMMED, DATA_ALTER>
, insn<sz_wb , NAME, OP<OPC + 0x000, m68k>, FMT_0RM_9, GEN, DATA_REG>
, insn<sz_wb , NAME, OP<OPC + 0x100, m68k>, FMT_9_0RM, DATA_REG, MEM_ALTER>

, insn<sz_l  , NAME, OP<OPC + 0x1C0, void>, FMT_0RM_9, GEN, ADDR_REG>
, insn<sz_w  , NAME, OP<OPC + 0x0C0, m68k>, FMT_0RM_9, GEN, ADDR_REG>
, insn<sz_l  , string::str_cat<NAME, STR("a")>, OP<OPC + 0x1C0, void>, FMT_0RM_9, GEN, ADDR_REG>
, insn<sz_w  , string::str_cat<NAME, STR("a")>, OP<OPC + 0x0C0, m68k>, FMT_0RM_9, GEN, ADDR_REG>
...
, std::conditional_t<is_xor, list<>,
  insn<sz_lwb, NAME, OP<OPC + 0x000>, FMT_0RM_9, DATA, DATA_REG>>
, insn<sz_lwb, NAME, OP<OPC + 0x100>, FMT_9_0RM, DATA_REG, MEM_ALTER>
...
, insn<sz_lwb, NAME, OP<0xe020+(mode<<3)+dir, TST>, FMT_9_0, DATA_REG, DATA_REG>
, insn<sz_lwb, NAME, OP<0xe000+(mode<<3)+dir, TST>, FMT_9_0, Q_MATH, DATA_REG>
...
using bit = list<list<>
, insn<sz_l, NAME, OP<0x0100+(mode<<6), TST>, FMT_9_0RM, DATA_REG, DATA_REG>
, insn<sz_b, NAME, OP<0x0100+(mode<<6), TST>, FMT_9_0RM, DATA_REG, DYNAMIC>
...
, insn<sz_l, STR("addq"), OP<0x5080>, FMT_9_0RM, Q_MATH, ALTERABLE>
, insn<sz_l, STR("add"),  OP<0x5080>, FMT_9_0RM, Q_MATH, ALTERABLE>
, insn<sz_l, STR("subq"), OP<0x5180>, FMT_9_0RM, Q_MATH, ALTERABLE>
, insn<sz_l, STR("sub"),  OP<0x5180>, FMT_9_0RM, Q_MATH, ALTERABLE>
, insn<sz_l, STR("neg"),  OP<0x4480>, FMT_0RM, DATA_ALTER>
, insn<sz_l, STR("not"),  OP<0x4680>, FMT_0RM, DATA_ALTER>

// byte,word (not coldfire)
, insn<sz_wb, STR("addq"), OP<0x5000, m68k>, FMT_9_0RM, Q_MATH, ALTERABLE>
, insn<sz_wb, STR("add"),  OP<0x5000, m68k>, FMT_9_0RM, Q_MATH, ALTERABLE>
, insn<sz_wb, STR("subq"), OP<0x5100, m68k>, FMT_9_0RM, Q_MATH, ALTERABLE>
, insn<sz_wb, STR("sub"),  OP<0x5100, m68k>, FMT_9_0RM, Q_MATH, ALTERABLE>
...
, insn<sz_lwb, STR("cmp"),  OP<0xb108, m68k>, FMT_0_9, POST_INCR, POST_INCR>
, insn<sz_lwb, STR("cmpm"), OP<0xb108, m68k>, FMT_0_9, POST_INCR, POST_INCR>

// multiply & divide (68000 forms)
, insn<sz_vw,  STR("muls"), OP<0xc1c0>, FMT_0RM_9, DATA, DATA_REG>
, insn<sz_vw,  STR("mulu"), OP<0xc0c0>, FMT_0RM_9, DATA, DATA_REG>
, insn<sz_vw,  STR("divs"), OP<0x41c0, divide>, FMT_0RM_9, DATA, DATA_REG>
, insn<sz_vw,  STR("divu"), OP<0x40c0, divide>, FMT_0RM_9, DATA, DATA_REG>
...
, insn<sz_l, STR("addx"), OP<0xd180, void>, FMT_0_9, DATA_REG, DATA_REG>
, insn<sz_l, STR("addx"), OP<0xd188, m68k>, FMT_0_9, PRE_DECR, PRE_DECR>
, insn<sz_l, STR("subx"), OP<0x9180, void>, FMT_0_9, DATA_REG, DATA_REG>
, insn<sz_l, STR("subx"), OP<0x9188, m68k>, FMT_0_9, PRE_DECR, PRE_DECR>
, insn<sz_l, STR("negx"), OP<0x4080, void>, FMT_0RM, DATA_REG>
, insn<sz_l, STR("negx"), OP<0x4080, m68k>, FMT_0RM, MEM_ALTER>

, insn<sz_wb, STR("addx"), OP<0xd100, m68k>, FMT_0_9, DATA_REG, DATA_REG>
, insn<sz_wb, STR("addx"), OP<0xd108, m68k>, FMT_0_9, PRE_DECR, PRE_DECR>
, insn<sz_wb, STR("subx"), OP<0x9100, m68k>, FMT_0_9, DATA_REG, DATA_REG>
, insn<sz_wb, STR("subx"), OP<0x9108, m68k>, FMT_0_9, PRE_DECR, PRE_DECR>
, insn<sz_wb, STR("negx"), OP<0x4000, m68k>, FMT_0RM, DATA_ALTER>

, insn<sz_lwb, STR("abcd"), OP<0xc100, m68k>, FMT_0_9, DATA_REG, DATA_REG>
, insn<sz_lwb, STR("abcd"), OP<0xc108, m68k>, FMT_0_9, PRE_DECR, PRE_DECR>
, insn<sz_lwb, STR("sbcd"), OP<0x8100, m68k>, FMT_0_9, DATA_REG, DATA_REG>
, insn<sz_lwb, STR("sbcd"), OP<0x8108, m68k>, FMT_0_9, PRE_DECR, PRE_DECR>
, insn<sz_lwb, STR("nbcd"), OP<0x4800, m68k>, FMT_0RM, DATA_ALTER>

// logical ops on SR & CCR
, insn<sz_b,   STR("or"),   OP<0x0000, m68k>, FMT_0RM, IMMED, CCR>
, insn<sz_b,   STR("ori"),  OP<0x0000, m68k>, FMT_0RM, IMMED, CCR>
, insn<sz_w,   STR("or"),   OP<0x0000, void>, FMT_0RM, IMMED, SR>
, insn<sz_w,   STR("ori"),  OP<0x0000, void>, FMT_0RM, IMMED, SR>
, insn<sz_b,   STR("and"),  OP<0x0200, m68k>, FMT_0RM, IMMED, CCR>
, insn<sz_b,   STR("andi"), OP<0x0200, m68k>, FMT_0RM, IMMED, CCR>
, insn<sz_w,   STR("and"),  OP<0x0200, void>, FMT_0RM, IMMED, SR>
, insn<sz_w,   STR("andi"), OP<0x0200, void>, FMT_0RM, IMMED, SR>
, insn<sz_b,   STR("eor"),  OP<0x0a00, m68k>, FMT_0RM, IMMED, CCR>
, insn<sz_b,   STR("eori"), OP<0x0a00, m68k>, FMT_0RM, IMMED, CCR>
, insn<sz_w,   STR("eor"),  OP<0x0a00, void>, FMT_0RM, IMMED, SR>
, insn<sz_w,   STR("eori"), OP<0x0a00, void>, FMT_0RM, IMMED, SR>
>;
...
// trapcc
, insn<sz_v, STR("trap"), OP<0x4e40>, FMT_4I, Q_4BITS>
...
, insn<sz_v, STR("bkpt"), OP<0x4848, m68010>, FMT_3I, Q_IMMED>
, insn<sz_v, STR("illegal"), OP<0x4afc>>
>;

using m68k_misc_v = list<list<>
, insn<sz_vl, STR("lea"),  OP<0x41c0>, FMT_0RM_9, CONTROL, ADDR_REG>
#if 1
, insn<sz_vw, STR("swap"), OP<0x4840>, FMT_0, DATA_REG>
, insn<sz_v , STR("pea"),  OP<0x4840>, FMT_0RM, CONTROL>
, insn<sz_lw, STR("ext"),  OP<0x4880, void, INFO_SIZE_WL>, FMT_0, DATA_REG>
, insn<sz_vb, STR("tas"),  OP<0x4ac0>, FMT_0RM, DATA_ALTER>
, insn<sz_w , STR("chk"),  OP<0x4180, m68k>, FMT_0RM_9, DATA, DATA_REG>

// 68000 user manual lists `link` as "unsized"
, insn<sz_wv, STR("link"), OP<0x4e50>, FMT_0, ADDR_REG, IMMED>
, insn<sz_v , STR("unlk"), OP<0x4e58>, FMT_0, ADDR_REG>
