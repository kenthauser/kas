...
, defn <sz_v , STR("pb") , MOP<MSH+0x80 , m68851,  INFO_CCODE_MMU1>
                                , FMT_CP_BRANCH, BRANCH_DEL_W>
, defn <sz_vw, STR("pdb"), MOP<0x48'0000, m68851,  INFO_CCODE_MMU1>
                                , FMT_CP_BRANCH, DATA_REG, BRANCH>
, defn <sz_b , STR("ps") , MOP<0x40'0000, void, INFO_CCODE_MMU1>
                                , FMT_0RM, DATA_ALTER>
, defn <sz_v , STR("ptrap"), MOP<0x7c'0000, void, INFO_CCODE_MMU1> >
, defn <sz_w , STR("ptrap"), MOP<0x7a'0000, void, INFO_CCODE_MMU1>, FMT_X, IMMED>
, defn <sz_l , STR("ptrap"), MOP<0x7b'0000, void, INFO_CCODE_MMU1>, FMT_X, IMMED>
>;
