...
namespace kas { namespace m68k {
    ...
    using m68k_ext_size_t = m68k_base_t;

    struct m68k_extension : kas::detail::alignas_t<m68k_extension, m68k_ext_size_t>
    {
        using base_t  = kas::detail::alignas_t<m68k_extension, m68k_ext_size_t>;
        ...
        m68k_extension(align_t ext = 0) : base_t(ext)
        {
        ...
        template <typename U>
        m68k_extension(U hw, U& inner, bool& is_brief);
    ...
    template <typename U>
    m68k_extension::m68k_extension(U hw, U& inner, bool& is_brief) : m68k_extension(0)
    {
    ...
    inline m68k_extension::align_t m68k_extension::hw_value() const
    {
        // calculate reg "byte";
    ...
    inline m68k_extension::align_t m68k_extension::brief_value(int disp) const
    {
        auto base = hw_value() & ~0x1ff;
        return base | (disp & 0xff);
    }

    using m68k_extension_t = m68k_extension;
    // using m68k_extension_t = alignas_t<m68k_extension, m68k_obj_data_t>;
}}
