#ifndef KAS_M68K_M68K_OPC_RESOLVED_H
#define KAS_M68K_M68K_OPC_RESOLVED_H
...
struct m68k_opc_resolved : m68k_stmt_opcode
{
    using base_t::base_t;
    
    OPC_INDEX();
    const char *name() const override { return "M68K_RESOLVED"; };
                 ...
                 ) override
    {
        ...
        // now use common emit
        m68k_opcode_emit(emit_obj, opcode, code, args, core::core_expr_dot());
