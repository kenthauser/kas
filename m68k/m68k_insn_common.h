...
#include "m68k_size_lwb.h"          // insert "size" into opcode
...
using SFX_CCODE_LIST    = meta::int_<0xc00>;     // raw FP code (for list): 6 bits shifted 6
...
using sz_list = meta::int_<SFX_NORMAL::value | SFX_CCODE_LIST::value | 0xff>;
